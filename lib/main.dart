  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text(
          "My Todo's",style: TextStyle(color: Colors.black), ),
          actions: [
            IconButton(
              onPressed: (){
            Fluttertoast.showToast(msg: "Please Use Floating Action Bar to add Todo",
      ...
      body: Container(
        ...
        child: Column(
         ...
         const   Text("Todo's Available!",style: TextStyle(color:Colors.grey, fontSize: 15)),
            const SizedBox( height: 12,),
            Expanded(
            child:   todos.isNotEmpty ? ListView.separated(
                    ...
                    child: Container(
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                    child: ListTile(
                                        leading:const Icon(CupertinoIcons.check_mark_circled,color: Colors.white,),
                    ...
                    [Column(
                      children: <Widget>[
                         Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                           children: [
      const Text("Good Day,Mr Kweku Anansi.",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w100,),),
                    Text(DateFormat('KK:mm a').format(DateTime.now()))
                     ],),
      const     SizedBox(height: 50,),
      const Text( 'Empty Todos...',style: TextStyle(fontSize: 35,fontWeight: FontWeight.bold),),
    Container(
      height: 300,
   ...
   TextButton(
     onPressed: (){
       ...
       setState(() {
         ...
         colors.add(Colors.primaries[Random().nextInt(Colors.primaries.length)].shade300);
       });
